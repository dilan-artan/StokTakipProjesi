...
namespace StokTakipProjesi.Blazor.Server {
    public partial class StokTakipProjesiBlazorApplication : BlazorApplication {
        public StokTakipProjesiBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void StokTakipProjesiBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
